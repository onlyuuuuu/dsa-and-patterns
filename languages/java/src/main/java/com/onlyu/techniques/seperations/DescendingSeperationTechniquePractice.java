...
public class DescendingSeperationTechniquePractice
{
    // Let's say that we have an array of numbers and we are given a value N
    // Let's separate the array into 2 parts, 1st part will be the larger or equal elements compared to the given value N
    // 2nd part will be smaller to the given value N
    // Do this inplace
